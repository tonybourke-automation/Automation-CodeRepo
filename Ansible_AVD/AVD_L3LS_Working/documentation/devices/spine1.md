...
| Ethernet7 | P2P_borderleaf1_Ethernet3 | - | 192.168.103.192/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_borderleaf2_Ethernet3 | - | 192.168.103.200/31 | default | 1500 | False | - | - |
...
| 192.168.103.193 | 65124 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.103.201 | 65124 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65001
   ...
   neighbor 192.168.103.193 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.193 remote-as 65124
   neighbor 192.168.103.193 description borderleaf1_Ethernet3
   neighbor 192.168.103.201 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.201 remote-as 65124
   neighbor 192.168.103.201 description borderleaf2_Ethernet3
