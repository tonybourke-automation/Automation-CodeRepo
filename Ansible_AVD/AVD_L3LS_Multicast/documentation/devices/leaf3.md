...
| Ethernet9 | Connection to host4 | *access | *20 | *- | *- | 9 |
...
!
interface Ethernet9
   description Connection to host4
   no shutdown
...
| Port-Channel9 | Connection to host4 | access | 20 | - | - | - | - | 9 | - |
...
| Loopback99 | DIAG_VRF_VRF_A | VRF_A | 192.168.109.3/32 |
...
| ---- | --------------- | ---------- | -------------- | ----------------- | -------------------------- | ----------------------- | ---------------------- | ------------------- | ------- |
| 10 | True | 192.168.101.3 | - | - | - | - | - | - | - |
| 20 | True | 192.168.101.3 | - | - | - | - | - | - | - |
...
ip igmp snooping vlan 10 querier address 192.168.101.3
ip igmp snooping vlan 20 querier
ip igmp snooping vlan 20 querier address 192.168.101.3
```
...
```eos
!
ip address virtual source-nat vrf VRF_A address 192.168.109.3
```
